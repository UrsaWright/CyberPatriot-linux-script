...
function main {
	...
	echo "run as 'sudo sh MTFS-linux.sh 2>&1 | tee output.log' to output the console output to a log file."
...
___  ___    ______    _   _              _   _   ___  __   __
|  \/  |    |  ___|  | | | |            | | | | / _ \ \ \ / /
| .  . | ___| |_ __ _| |_| |_ ___ _ __  | |_| |/ /_\ \ \ V / 
| |\/| |/ __|  _/ _` | __| __/ _ \ '__| |  _  ||  _  | /   \ 
| |  | | (__| || (_| | |_| ||  __/ |    | | | || | | |/ /^\ \
\_|  |_/\___\_| \__,_|\__|\__\___|_|    \_| |_/\_| |_/\/   \/
